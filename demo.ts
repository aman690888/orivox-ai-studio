  ...
  public async routeToJSON<T>(
    ...
    if (prompt.includes("Orivox Presentation Planner")) {
      return {
        ...
        section_hierarchy: [
          { title: "Intro", focus: "Hook", estimated_slides: 1, key_takeaways: [] },
          { title: "Body", focus: "Data", estimated_slides: 1, key_takeaways: [] },
        ],
        ...
        slides: [
          {
            ...
            section_id: "sec-1",
            slide_number: 1,
            slide_purpose: "Title Slide",
            required_visual_emphasis: "High",
            estimated_word_budget: 10,
          ...
          },
          {
            ...
            section_id: "sec-2",
            slide_number: 2,
            slide_purpose: "Show Data",
            required_visual_emphasis: "High",
            estimated_word_budget: 30,
    ...
    if (prompt.includes("Orivox Layout Planner")) {
      return {
        layouts: [
          {
            slide_id: "slide-1",
            selected_layout_id: "layout-title",
            confidence_score: 0.9,
            required_component_slots: ["Title", "Subtitle"],
            layout_constraints: {
              max_components: 2,
              max_images: 1,
              max_charts: 0,
          ...
          {
            slide_id: "slide-2",
            selected_layout_id: "layout-chart-left",
            confidence_score: 0.9,
            required_component_slots: ["Title", "Chart"],
            layout_constraints: {
              max_components: 3,
              max_images: 0,
              max_charts: 1,
        ...
        slides: [
          {
            ...
            placeholders: [
              {
                placeholder_id: "{{title_1}}",
                owning_component_id: "comp-title-1",
                content_type: "title",
                max_words: 5,
                min_words: 1,
              },
              {
                placeholder_id: "{{sub_1}}",
                owning_component_id: "comp-sub-1",
          ...
          },
          {
            ...
            placeholders: [
              {
                placeholder_id: "{{title_2}}",
                owning_component_id: "comp-title-2",
                content_type: "title",
                max_words: 5,
                min_words: 1,
              },
              {
                placeholder_id: "{{chart_data_1}}",
                owning_component_id: "comp-chart-1",
                content_type: "chart_dataset",
                max_words: 15,
                min_words: 1,
              },
            ],
...
async function runDemo() {
  ...
  const ir = await runner.executePipeline(
    "Create a 10-slide presentation about Artificial Intelligence in Healthcare.",
  );
