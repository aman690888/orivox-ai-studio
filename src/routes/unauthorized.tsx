...
export const Route = createFileRoute("/unauthorized")({
  head: () => ({ meta: [{ title: "Unauthorized — Orivox" }] }),
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-[#6b6460]" style={{ fontFamily: "Patrick Hand, cursive" }}>
          You need to sign in to access this page. Let's get you authenticated!
        </p>
        <div className="flex gap-3">
          ...
          <Link
            to="/home"
            className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-bold bg-[#fdfbf7] text-[#2d2d2d] border-[2.5px] border-[#2d2d2d] shadow-[4px_4px_0px_0px_#2d2d2d] hover:bg-[#e5e0d8] hover:shadow-[2px_2px_0px_0px_#2d2d2d] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-100"
            style={{ borderRadius: R.tag, fontFamily: "Kalam, cursive" }}
          >
            Back Home
          </Link>
