...
export const AssetRenderer: React.FC<{ asset: AssetIR; className?: string }> = ({
  asset,
  className,
}) => {
    ...
    return (
      ...
      >
        <img
          src={
            asset.url ||
            `https://source.unsplash.com/random/800x600?${encodeURIComponent(asset.generation_prompt || "abstract")}`
          }
  ...
  if (asset.type === "video") {
    return <video src={asset.url} className={className || "w-full h-auto object-cover"} controls />;
  }
