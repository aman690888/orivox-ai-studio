...
export const EditorProvider: React.FC<{ initialIr: PresentationIR; children: React.ReactNode }> = ({
  initialIr,
  children,
}) => {
  ...
  const updateComponentData = useCallback(
    (slideId: string, componentId: string, newData: any) => {
