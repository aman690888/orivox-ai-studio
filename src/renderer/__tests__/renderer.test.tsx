...
vi.mock("@tanstack/react-start", () => {
  return {
    createServerFn: () => {
      const fn = Object.assign(vi.fn().mockResolvedValue({ success: true }), {
        validator: () => fn,
        handler: () => fn,
      });
      return fn;
...
describe("React Components", () => {
    ...
    const TestComponent = () => {
      ...
      return (
        <div>
          ...
          <button onClick={() => updateComponentData("s1", "c1", { content: "Updated Title" })}>
            Update
          </button>
        ...
        return (
          <div>
            <EditableText
              ...
              componentId="c1"
              field="content"
              value={ir.slides["s1"].components_data["c1"].data.content}
            />
      ...
      const TestComponent = () => {
        ...
        return (
          <div>
            ...
            <button
              data-testid="btn"
              onClick={() => updateComponentData("s1", "c1", { content: "Changed" })}
            >
              Change
            </button>
          </div>
  ...
  describe("SlideCanvas Navigation", () => {
    it("ignores arrow keys when typing in an input", () => {
      ...
      multiSlideIr.slides["s2"] = {
        ...multiSlideIr.slides["s1"],
        id: "s2",
        components_data: { c1: { id: "c1", type: "Title", data: { content: "Slide 2" } } },
      } as any;

      render(
        <EditorProvider initialIr={multiSlideIr}>
          <SlideCanvas />
        </EditorProvider>,
      );
