...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary/90 backdrop-blur-md text-primary-foreground shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)] hover:bg-primary hover:shadow-[0_0_10px_color-mix(in_oklab,var(--color-primary)_50%,transparent)]",
        secondary:
